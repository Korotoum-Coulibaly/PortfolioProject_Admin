          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Nouveau Devis</p>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Remise</p>
                    <h5 class="font-weight-bolder">
                     1
                    </h5>
                    <p class="mb-0">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Nouveau prospect</p>
                    <h5 class="font-weight-bolder">
                      3
                    </h5>
                    <p class="mb-0">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Rebond</p>
                    <h5 class="font-weight-bolder">
                      0
                    </h5>
                    <p class="mb-0">
                      <span class="text-success text-sm font-weight-bolder">+0%</span> Depuis hier
                    </p>
                  </div>
                </div>
                <div class="col-4 text-end">
