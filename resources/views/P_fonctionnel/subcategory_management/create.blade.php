...
@include('layouts.sidebar')
    ...
    <div class=" card jumbotron ">
        <div class=" card-body ">
            <form method="POST" action="{{ route("subcategorymanagement.store") }}" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <a class="btn btn-secondary" href="{{ route('subcategorymanagement.index') }}">Back</a>
                </div>
                <div class="form-group ">
                ...
                <div class="form-group ">
                    <label class="required" for="categorie">Libelle</label>
                    <input class="form-control {{ $errors->has('libelle') ? 'is-invalid' : '' }}" type="text" name="libelle" id="libelle" value="{{ old('libelle', '') }}" required>
                    @if($errors->has('libelle'))
                        <div class="invalid-feedback">
                            {{ $errors->first('libelle') }}
