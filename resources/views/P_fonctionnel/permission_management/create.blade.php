...
@include('layouts.sidebar')
    ...
    <div class=" card jumbotron ">
        <div class=" card-body ">
            <form method="POST" action="{{ route("permissionmanagement.store") }}" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <a class="btn btn-secondary" href="{{ route('permissionmanagement.index') }}">Back</a>
                </div>
                <div class="form-group ">
